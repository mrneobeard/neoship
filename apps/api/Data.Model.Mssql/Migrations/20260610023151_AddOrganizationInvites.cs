        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    token_digest = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    invited_by_user_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    pending_role_ids_json = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: true),
                    pending_group_ids_json = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: true),
