...
/// <summary>
/// Represents an RGB color in Display P3 color space.
/// </summary>
/// <remarks>
/// <example>
/// <code lang="csharp">
/// var color = new DisplayP3(1d, 0.5d, 0d).ToRgb();
/// Assert.Equal(new Rgb(255, 128, 0), color);
/// </code>
/// </example>
/// </remarks>
public readonly struct DisplayP3 : IEquatable<DisplayP3>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DisplayP3"/>.
    /// </summary>
    /// <param name="red">The red component.</param>
    /// <param name="green">The green component.</param>
    /// <param name="blue">The blue component.</param>
    public DisplayP3(double red, double green, double blue)
    {
    ...
    /// <summary>
    /// Converts this Display P3 color to RGB.
    /// </summary>
    ...
    /// <summary>
    /// Deconstructs the color into Display P3 components.
    /// </summary>
    /// <param name="red">The red component.</param>
    /// <param name="green">The green component.</param>
    /// <param name="blue">The blue component.</param>
    ...
    /// <summary>
    /// Determines whether this instance equals another <see cref="DisplayP3"/> instance.
    /// </summary>
    /// <param name="other">The other instance to compare.</param>
    /// <returns><c>true</c> if the instances are approximately equal; otherwise, <c>false</c>.</returns>
    public bool Equals(DisplayP3 other)
    {
    ...
    /// <returns><c>true</c> if the object is a <see cref="DisplayP3"/> and equals this instance; otherwise, <c>false</c>.</returns>
    public override bool Equals(object? obj)
    {
        return obj is DisplayP3 other && this.Equals(other);
    }
    ...
    public static implicit operator Rgb(DisplayP3 value)
    {
        return value.ToRgb();
    }
