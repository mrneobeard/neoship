...
/// <summary>
/// Represents an RGB color in the Adobe RGB (1998) color space.
/// </summary>
/// <remarks>
/// <example>
/// <code lang="csharp">
/// var color = new AdobeRgb(1d, 0.5d, 0d).ToRgb();
/// Assert.Equal(new Rgb(255, 128, 0), color);
/// </code>
/// </example>
/// </remarks>
public readonly struct AdobeRgb : IEquatable<AdobeRgb>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AdobeRgb"/>.
    /// </summary>
    /// <param name="red">The red component.</param>
    /// <param name="green">The green component.</param>
    /// <param name="blue">The blue component.</param>
    public AdobeRgb(double red, double green, double blue)
    {
    ...
    /// <summary>
    /// Converts this Adobe RGB color to RGB.
    /// </summary>
    ...
    /// <summary>
    /// Deconstructs the color into Adobe RGB components.
    /// </summary>
    /// <param name="red">The red component.</param>
    /// <param name="green">The green component.</param>
    /// <param name="blue">The blue component.</param>
    ...
    /// <summary>
    /// Determines whether this instance equals another <see cref="AdobeRgb"/> instance.
    /// </summary>
    /// <param name="other">The other instance to compare.</param>
    /// <returns><c>true</c> if the instances are approximately equal; otherwise, <c>false</c>.</returns>
    public bool Equals(AdobeRgb other)
    {
    ...
    /// <returns><c>true</c> if the object is an <see cref="AdobeRgb"/> and equals this instance; otherwise, <c>false</c>.</returns>
    public override bool Equals(object? obj)
    {
        return obj is AdobeRgb other && this.Equals(other);
    }
    ...
    public static implicit operator Rgb(AdobeRgb value)
    {
        return value.ToRgb();
    }
