...
public interface ICertificateRequestBuilder
{
    ...
    ICertificateRequestBuilder WithCertificatePolicies(params Oid[] policies);
    ...
    ICertificateRequestBuilder WithOcspUrls(params Uri[] urls);

    ICertificateRequestBuilder WithCaIssuerUrls(params Uri[] urls);
