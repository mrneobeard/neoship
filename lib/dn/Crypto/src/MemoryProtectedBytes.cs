...
namespace NeoBeard.Crypto
{
    ...
    public class MemoryProtectedBytes : IEquatable<MemoryProtectedBytes>, IDisposable
    {
        ...
        public Memory<byte> Hash { get; protected set; }
        ...
        public bool Equals(ReadOnlySpan<byte> bytes)
        {
            ...
            return CryptographicOperations.FixedTimeEquals(hash, this.Hash.Span);
        }
        ...
        public bool Equals(MemoryProtectedBytes? other)
        {
            ...
            return CryptographicOperations.FixedTimeEquals(this.Hash.Span, other.Hash.Span);
        }
        ...
        {
            this.Hash = EncryptionUtil.ComputeChecksum(bytes, HashAlgorithmName.SHA256).ToArray();
        }
