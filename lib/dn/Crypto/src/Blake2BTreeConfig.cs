...
/// <summary>
/// Describes BLAKE2b tree hashing parameters.
/// </summary>
/// <remarks>
/// <example>
/// <code lang="csharp">
/// var config = new Blake2BTreeConfig(2, 2, 1024, 0, 0, 64, false);
/// Assert.Equal(2, config.FanOut);
/// </code>
/// </example>
/// </remarks>
public readonly struct Blake2BTreeConfig : IEquatable<Blake2BTreeConfig>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Blake2BTreeConfig"/> struct.
    /// </summary>
    ...
    /// <example>
    /// <code lang="csharp">
    /// var config = new Blake2BTreeConfig(2, 2, 1024, 1, 0, 64, true);
    /// Assert.True(config.IsLastNode);
    /// </code>
    /// </example>
    /// </remarks>
    public Blake2BTreeConfig(byte fanOut, byte depth, int leafLength, long nodeOffset, byte nodeDepth, int innerHashLength, bool isLastNode)
    {
        if (leafLength < 0)
        {
        ...
        if (innerHashLength is < 0 or > 64)
        {
            throw new ArgumentOutOfRangeException(nameof(innerHashLength), "Inner hash length must be between 0 and 64 bytes.");
        }
    ...
    /// <summary>
    /// Gets the sequential BLAKE2b tree configuration.
    /// </summary>
    /// <remarks>
    /// <example>
    /// <code lang="csharp">
    /// var config = Blake2BTreeConfig.Sequential;
    /// Assert.Equal(1, config.FanOut);
    /// </code>
    /// </example>
    /// </remarks>
    public static Blake2BTreeConfig Sequential => new(1, 1, 0, 0, 0, 0, false);
    ...
    /// <example>
    /// <code lang="csharp">
    /// var config = new Blake2BTreeConfig(2, 2, 1024, 1, 0, 64, false);
    ...
    /// <example>
    /// <code lang="csharp">
    /// var config = new Blake2BTreeConfig(2, 2, 1024, 0, 1, 64, true);
    ...
    /// <code lang="csharp">
    /// var config = new Blake2BTreeConfig(2, 2, 1024, 0, 0, 64, false);
    /// Assert.Equal(64, config.InnerHashLength);
    /// </code>
    /// </example>
    /// </remarks>
    ...
    /// <summary>
    /// Determines whether this instance equals another BLAKE2b tree configuration.
    /// </summary>
    ...
    /// <example>
    /// <code lang="csharp">
    /// Assert.True(Blake2BTreeConfig.Sequential.Equals(Blake2BTreeConfig.Sequential));
    /// </code>
    /// </example>
    /// </remarks>
    public bool Equals(Blake2BTreeConfig other)
    ...
    /// <example>
    /// <code lang="csharp">
    /// Assert.True(Blake2BTreeConfig.Sequential.Equals((object)Blake2BTreeConfig.Sequential));
    /// </code>
    /// </example>
    /// </remarks>
    public override bool Equals(object? obj) => obj is Blake2BTreeConfig other && this.Equals(other);
    ...
    /// <example>
    /// <code lang="csharp">
    /// var hashCode = Blake2BTreeConfig.Sequential.GetHashCode();
    ...
    /// <example>
    /// <code lang="csharp">
    /// Assert.True(Blake2BTreeConfig.Sequential == Blake2BTreeConfig.Sequential);
    /// </code>
    /// </example>
    /// </remarks>
    public static bool operator ==(Blake2BTreeConfig left, Blake2BTreeConfig right) => left.Equals(right);
    ...
    /// Assert.True(Blake2BTreeConfig.Sequential != tree);
    /// </code>
    /// </example>
    /// </remarks>
    public static bool operator !=(Blake2BTreeConfig left, Blake2BTreeConfig right) => !left.Equals(right);
